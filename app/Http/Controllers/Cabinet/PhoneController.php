...
class PhoneController extends Controller
{
    ...
    public function request()
    {
        ...
        return redirect()->route('cabinet.profile.phone', 1);
    }
    ...
    public function verify(PhoneVerifyRequest $request)
    {
        try {
            ...
            return redirect()->route('cabinet.profile.phone', 1)->with('error', $e->getMessage());
        }

        return redirect()->route('cabinet.profile.home', 1);
    }
