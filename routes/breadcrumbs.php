...
Breadcrumbs::register('cabinet.banners.show', function (Crumbs $crumbs, $subdomain_userid, Banner $banner) {
  $crumbs->parent('cabinet.banners.index');
  $crumbs->push($banner->name, route('cabinet.banners.show', [$subdomain_userid, $banner]));
});
...
Breadcrumbs::register('cabinet.tickets.show', function (Crumbs $crumbs, $subdomain_userid, Ticket $ticket) {
  $crumbs->parent('cabinet.tickets.index');
  $crumbs->push($ticket->subject, route('cabinet.tickets.show', [$subdomain_userid, $ticket]));
});
